...
def main():
    ...
    if choice == 'Detection':
        ...
        if image_file is not None:
            ...
            enhance_type = st.sidebar.radio("Enhance Type",["Original","Gray-Scale","Contrast","Brightness","Blurring","Sharpening","Pencil Sketch"])
        ...
        #! st.title("About App")
        st.markdown(f'<p style="font-family:Georgia; color:#09ff00; font-size:20px;"> <b>About App</b> </p>' , unsafe_allow_html=True)

        st.text("Build by using Streamlit and OpenCV")
        st.text("App to edit an image and detect different parts of a face.")

        st.text("Made with ❤ by Tushar.")
